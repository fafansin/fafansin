...
export default function Quote(){
  ...
  return(
    <div className="quote-wrap px-1 px-md-5 " style={{backgroundColor:color}}>
      <div id="quote-box" className="jumbotron border shadow rounded p-4" style={{color:color, backgroundColor:"#ffffff"}}>
        <blockquote>
          <h1 className="display-6" id="text">{`" ${list[indexer].quote} "`}</h1>
        ...
        <div className="d-flex justify-content-end gap-2">
          <Button 
            ...
            onClick={getRandom}>New Quote</Button>
          <a href="https://twitter.com/intent/tweet" 
            target="_blank" 
            rel="noreferrer" 
            id="tweet-quote" 
            style={{backgroundColor:color, border:"none"}}
            className="btn btn-primary btn-small">Tweet Me</a>
        </div>
      </div>
    </div>
  )
